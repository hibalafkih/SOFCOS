...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_info'])) {
        ...
        $stmtUp = $pdo->prepare("UPDATE clients SET nom=?, prenom=?, email=?, telephone=? WHERE id=?");
        if($stmtUp->execute([$nom, $prenom, $email, $telephone, $client_id])) {
...
<head>
    ...
    <title>Mes Informations - SOFCOS</title>
    ...
    <style>
        ...
        .btn-submit { background: var(--primary); color: white; border: none; padding: 15px 40px; font-family: 'Montserrat', sans-serif; text-transform: uppercase; letter-spacing: 1px; font-weight: 600; font-size: 13px; cursor: pointer; transition: 0.3s; border-radius: 4px; }
        ...
        @media (max-width: 900px) { .dashboard-container { grid-template-columns: 1fr; } .form-row { grid-template-columns: 1fr; } }
    </style>
</head>
<body>
    ...
    <div class="dashboard-container">
        <div class="sidebar">
            ...
            <ul class="menu-list">
                ...
                <li><a href="mes-informations.php" class="menu-link active"><i class="fas fa-user-edit"></i> Profil</a></li>
